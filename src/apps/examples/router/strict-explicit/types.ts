...
import type { ValidateKebabCase } from '@/packages/@mzhvv/utils/string'

import type { IndexRouteObject } from '../../../../packages/@mzhvv/router/routes/types/foundation'
import type {
...
} from '../../../../packages/@mzhvv/router/routes/types/strict-explicit'
