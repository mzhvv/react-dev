...
// export const Variant1: React.FC<ThemeRadioGroupProps> = ({ options, theme, onThemeChange, id }) => {
//   return (
//     <RadioGroup
//       value={theme}
...
export const Variant2: React.FC<ThemeRadioGroupProps> = ({ options, theme, onThemeChange, id }) => {
  return (
    <RadioGroup
      value={theme}
      onValueChange={onThemeChange}
...
// export const Variant3: React.FC<ThemeRadioGroupProps> = ({ options, theme, onThemeChange, id }) => {
//   return (
//     <RadioGroup
//       value={theme}
//       onValueChange={onThemeChange}
...
//     >
//       {options.map(option => (
//         <label key={`${id}-${option.value}`} htmlFor={`${id}-${option.value}`} className='relative'>
//           <RadioGroupItem
//             id={`${id}-${option.value}`}
//             value={option.value}
