// src/packages/ui/shadcn/components/__default__/button.tsx
...
import type { CvaClasses } from '@packages/libs/classes/cva'
...
export const buttonVariants = cva(buttonCvaClasses.base, buttonCvaClasses.variants)
