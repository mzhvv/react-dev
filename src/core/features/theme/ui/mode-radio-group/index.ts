...
import type { FactoryComponentVariantsConfig } from '@/packages/libs/factories/component-variants'
import { createComponentVariantsFactory } from '@/packages/libs/factories/component-variants'
